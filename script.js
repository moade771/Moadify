const app = {
    ...
    updateRangeBackground: (rangeInput) => {
        ...
        rangeInput.style.background = `linear-gradient(to right, var(--primary-color) 0%, var(--primary-color) ${value}%, #555 ${value}%, #555 100%)`;
    },
    ...
    setupSettings: () => {
        ...
        bindToggle('vol-norm-toggle', 'volumeNormalization');
